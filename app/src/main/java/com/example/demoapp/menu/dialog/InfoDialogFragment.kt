package com.example.demoapp.menu.dialog
...
import com.example.demoapp.databinding.FragmentInfoDialogBinding
...
class InfoDialogFragment (
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        _binding = FragmentInfoDialogBinding.inflate(layoutInflater)
